...
const Navbar = ({ onAddPostClick, email, onSignOut }) => {
  return (
    <nav className="bg-white px-4 sm:px-6 py-4 border-b border-gray-200">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3 sm:space-x-4">
          ...
          <button
            onClick={onSignOut}
            className="bg-white hover:bg-red-50 border-2 border-red-500 text-red-600 p-2 sm:px-6 sm:py-3 sm:text-base sm:font-medium rounded-lg transition duration-200 cursor-pointer"
          >
            <span className="sm:hidden">
              <FiLogOut size={20} />
            </span>
